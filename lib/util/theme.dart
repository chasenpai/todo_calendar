...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      onPrimaryContainer: Color(4279898697),
      secondary: Color(4284439665),
      onSecondary: Color(4294967295),
      secondaryContainer: Color(4293255161),
      onSecondaryContainer: Color(4279965996),
      tertiary: Color(4286272101),
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4294957288),
      onTertiaryContainer: Color(4281340193),
      ...
      onPrimaryFixed: Color(4279898697),
      primaryFixedDim: Color(4291280895),
      onPrimaryFixedVariant: Color(4282793847),
      secondaryFixed: Color(4293255161),
      ...
      onTertiaryFixed: Color(4281340193),
      tertiaryFixedDim: Color(4293703886),
      onTertiaryFixedVariant: Color(4284562253),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      brightness: Brightness.light,
      primary: Color(4282530675),
      surfaceTint: Color(4284307345),
      onPrimary: Color(4294967295),
      primaryContainer: Color(4285820329),
      onPrimaryContainer: Color(4294967295),
      secondary: Color(4282597461),
      onSecondary: Color(4294967295),
      secondaryContainer: Color(4285887112),
      onSecondaryContainer: Color(4294967295),
      tertiary: Color(4284299081),
      onTertiary: Color(4294967295),
      ...
      tertiaryFixedDim: Color(4286140515),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(4284307345),
      onPrimary: Color(4294967295),
      primaryContainer: Color(4282530675),
      onPrimaryContainer: Color(4294967295),
      ...
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4284299081),
      onTertiaryContainer: Color(4294967295),
      ...
      onSecondaryFixedVariant: Color(4294967295),
      tertiaryFixed: Color(4284299081),
      onTertiaryFixed: Color(4294967295),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      primaryContainer: Color(4282793847),
      ...
      onSecondaryContainer: Color(4293255161),
      tertiary: Color(4293703886),
      onTertiary: Color(4282918199),
      tertiaryContainer: Color(4284562253),
  ...
  static MaterialScheme darkMediumContrastScheme() {
    return const MaterialScheme(
      ...
      outlineVariant: Color(4286939788),
      shadow: Color(4278190080),
      scrim: Color(4278190080),
      inverseSurface: Color(4293255657),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      secondaryContainer: Color(4291676385),
      onSecondaryContainer: Color(4278190080),
      ...
      inversePrimary: Color(4280820312),
      ...
      secondaryFixedDim: Color(4291676385),
